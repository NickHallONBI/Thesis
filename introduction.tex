...
to the Noll indexing convention, although modal bases and ording 
...
due to heterogeneties in the structure of the biological sample being 
...
the phase distortion, then a ideal, diffraction limited focal spot is 
recovered. Since the phase distortions encounterd are not only sample
...
is considered. A distorted wavefront $\Phi_{I}$, arrives at the aperature 
...
sensorless correaction methodologies\cite{burke2015adaptive,booth2002adaptive,
...
Since there is no univerally agreed upon AO implementation, each 
...
to any other system, imaging modality, sample type, etc. There is a need for a
robust, accurate, easy-to-use, general implementation of adaptive optics for 
microscopy\cite{ji2017adaptive,rodriguez2018adaptive}
