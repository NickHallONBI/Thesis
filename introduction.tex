...
fluorophores, have more complex energy level landscapes and broad ``energy bands'' of possible excitation and emission 
...
Consider a point source located at $\textbf{O}$ isotropically emitting 
...
\tilde{a}^{*}(\textbf{k})$ - where $\tilde{a}^{*}$ is the complex conjugate of $\tilde{a}$ - only one component need be calculated and the
...
aberrations and the real-valued function $\Phi\left(\rho,\theta\right)$ 
...
appropriate do not generally arise in a biological context. Additionally, the Zernike modes have 
...
Dynamic Optics and Photonics Group, University of Oxford and Toshiki Kubo of the
