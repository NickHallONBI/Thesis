...
projection of $13\mu$m SIM z-stacks and a $xz$ slice at the mid point of 
...
estimate\cite\cite{den1997resolution}. For a structure such as that present 
...
artifacts, primarily ``echo'' stuctures above the true fluorescent 
...
reduced dynamic range for visability. Applying the AO correction recovers 
