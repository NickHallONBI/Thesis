...
for wavelengths $525$nm and $610$nm respectively. These wavelengths 
are chosen as they are the mid-point wavelenghts for the green and 
red emission filters respectively. The stripe width was $322$nm and 
$367$nm for $488$nm and $561$nm excitation wavelengths respectively.
...
pair is marked in Figure~\ref{fig:Argolight_slide_woAO_axis} and 
...
\begin{figure*}
	...
	data acquired on the DeepSIM imaging system]{Fourier plots of 
		...
		AO correction \textbf{(b)} red channel without AO correction 
		\textbf{(c)} green channel with AO correction \textbf{(d)} red 
